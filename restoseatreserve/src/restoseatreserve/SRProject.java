		...
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (tab >= 0) {
					if (select == 0) {
						mod.removeRow(tab);
						JOptionPane.showMessageDialog(null, "Reservation Succesfully removed!");
					} else {	
		...
		btnReset.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (select == 0) {
					...
					Rmod.setRowCount(0);
					JOptionPane.showMessageDialog(null, "Reservations Data Succesfully Deleted!");
				} else {
					JOptionPane.showMessageDialog(null, "Data has been retained!");
				}
			}
